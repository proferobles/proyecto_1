...
var Mario = L.marker([-34.837869,-58.341797], {icon: azul},13).bindPopup("<strong>Granja Don Mario<strong>" + "<br/>" + "Laprida 2192,Ministro Rivadavia" + "<br/>" + "Contacto: 4279 0182 " + " Email: leandro_heevel@hotmail.com" + "<br/>" + "<br/>" + "<img src= 'F.jpg'/>" + "#'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Changuitos = L.marker([-34.843393,-58.320977], {icon: azul},13).bindPopup("<strong>Los Changuitos<strong>" + "<br/>" + "Lezica 2065,Ministro Rivadavia" + "<br/>" + "Contacto: 1155281255" + "<br/>" + "<img src= 'O.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var airesdelsur = L.marker([-34.846589,-58.336754], {icon: azul},13).bindPopup("<strong>Parapentes Aires del Sur<strong>" + "<br/>" + "Juan B. Justo 2100,Ministro Rivadavia" + "<br/>" + "Contacto: 1166411558	1153748148 1155166387" + "<br/>" + "<img src= 'V.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Selva = L.marker([-34.836571,-58.355524], {icon: azul},13).bindPopup("<strong>Selva Madre<strong>" + "<br/>" + "María A. de Lescano 221,Ministro Rivadavia" + "<br/>" + "Contacto: 011 1526756449  1162182559" + "<br/>" + "<img src= 'AE.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
var Robinson = L.marker([-34.839381,-58.319434], {icon: azul},13).bindPopup("<strong>Las Vueltas de Robinson<strong>" + "<br/>" + "Av. Juan B. Justo 3699-3773,Ministro Rivadavia" + "<br/>" + "Contacto: 011 2492-3030" + "<br/>" + "<img src= 'AF.jpg'/>" + "<A HREF='FB: LasVueltasDeRobinson'> Mas info... </A> " ).on('click', xxy).addTo(map);
var Loma = L.marker([-34.835387,-58.355437], {icon: azul},13).bindPopup("<strong>Quinta La Loma<strong>" + "<br/>" + "25 de Mayo 1547,Ministro Rivadavia" + "<br/>" + "Contacto: 1163751686 " + "<br/>" + " Email: evelynsol02@hotmail.com" + "<br/>"+ "<img src= 'AG.jpg'/>" + "<A HREF='#'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Facundo = L.marker([-34.846589,-58.336754], {icon: azul},13).bindPopup("<strong>Don Facundo<strong>" + "<br/>" + "Juan B Justo 2100,Ministro Rivadavia" + "<br/>" + "Contacto: 1155166387" + " Email: facundoapple1701@gmail.com" + "<br/>" + "<img src= 'AK.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
var Municipal = L.marker([-34.85378929808223 ,-58.34893014346852], {icon: azul},13).bindPopup("<strong>Granja Educativa Municipal<strong>" + "<br/>" + "Av Juan B Justo 1000,Ministro Rivadavia" + "<br/>" + "Contacto: 1150346200" + "Email: granjaeducativamunicipal@brown.gob.ar" + "<br/>" + "<img src= 'AL.jpg'/>" + "<A HREF='FB: Granja Educativa Municipal Brown IG: @granjamunicipalbrown'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Luisa = L.marker([-34.851402,-58.359132], {icon: azul},13).bindPopup("<strong>Estancia La Luisa<strong>" + "<br/>" + "Av. República Argentina 6649,Ministro Rivadavia" + "<br/>" + "Contacto: 1136185349	1136185349" + "<br/>" + "<img src= 'AN.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Amelie = L.marker([-34.831943,-58.349281], {icon: azul},13).bindPopup("<strong>Estancia Amelie<strong>" + "<br/>" + "Batalla de Cancha Rayada 825,Ministro Rivadavia" + "<br/>" + "Contacto: 1160458295	011 5993-8342" + "<br/>" + "Email: estancia@amelieventos.com" + "<br/>"  + "<img src= 'AT.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var panificadora = L.marker([-34.854219,-58.350772], {icon: azul},13).bindPopup("<strong>Centro de Formación para el Trabajo en Panificados y Gastronomía<strong>" + "<br/>" + "Av Juan B Justo 900,Ministro Rivadavia" + "<br/>" + "Contacto: empleo@gmail.gob.ar" + "<br/>" + "<img src= 'AL.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
var CEA = L.marker([-34.856548,-58.354818], {icon: azul},13).bindPopup("<strong>CEA 34 Centro de Educación Agraria<strong>" + "<br/>" + "Av. Juan B. Justo 8505,Ministro Rivadavia" + "<br/>" + "Contacto: " + "<br/>" + "<img src= 'AM.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
var Sasaki = L.marker([-34.884281,-58.334975], {icon: azul},13).bindPopup("<strong>Sasaki<strong>" + "<br/>" + "Coronel Quesada 4441 Ministro Rivadavia" + "<br/>" + "Contacto: 1155958955	1155958955" + "<br/>" + "<img src= 'AN.jpg'/>" + "<A HREF='FB: EstanciaLaLuisa'> Mas info... </A> " ).on('click', xxy).addTo(map);
var SOL = L.marker([-34.883627,-58.333632], {icon: azul},13).bindPopup("<strong>Sol y Verde es Vida<strong>" + "<br/>" + "Coronel Quesada 4446 Ministro Rivadavia" + "<br/>" + "Contacto: 1121619500	1121619500" + "<br/>" + "<img src= 'AO.jpg'/>" + "<A HREF=''> Mas info... </A> " ).on('click', xxy).addTo(map);
