...
var tierra_frutos = L.marker([-34.845781,-58.331646], {icon: azul},13).bindPopup("<strong>Tierra y frutos<strong>" + "<br/>" + "Juan B Justo 2316,Ministro Rivadavia" + "<br/>" + "Contacto: 1165850087" + "<br/>" + " Email: hornerosabio@yahoo.com.ar" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/09/Copia-de-_DSC6812-scaled.jpg'/>" + "<A HREF='https://descubribrown.ar/tierra-y-frutos/'> Mas info... </A> " ).on('click', xxy).addTo(map);
var Mario = L.marker([-34.837869,-58.341797], {icon: azul},13).bindPopup("<strong>Granja Don Mario<strong>" + "<br/>" + "Laprida 2192,Ministro Rivadavia" + "<br/>" + "Contacto: 4279 0182 " + " Email: leandro_heevel@hotmail.com" + "<br/>" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/10/Copia-de-Don-Mario-6-scaled.jpg'/>" + "<A HREF='https://descubribrown.ar/granja-don-mario/'> Mas info... </A> " ).on('click', xxy).addTo(map);
var Medina = L.marker([-34.842964,-58.333378], {icon: azul},13).bindPopup("<strong>Los Medina<strong>" + "<br/>" + "Chivilcoy 2320,Ministro Rivadavia" + "<br/>" + "Contacto: 1123686982 " + " Email: luis.javier.medina@hotmail.com" + "<br/>" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/09/Copia-de-13-queso-medina-scaled.jpg'/>" + "<A HREF='https://descubribrown.ar/los-medina/'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Changuitos = L.marker([-34.843393,-58.320977], {icon: azul},13).bindPopup("<strong>Los Changuitos<strong>" + "<br/>" + "Lezica 2065,Ministro Rivadavia" + "<br/>" + "Contacto: 1155281255" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/10/8-Changuitos_page-0001-1.jpg'/>" + "<A HREF='https://descubribrown.ar/los-changuitos/'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var airesdelsur = L.marker([-34.846589,-58.336754], {icon: azul},13).bindPopup("<strong>Parapentes Aires del Sur<strong>" + "<br/>" + "Juan B. Justo 2100,Ministro Rivadavia" + "<br/>" + "Contacto: 1166411558	1153748148 1155166387" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/09/288998014_450239660265605_7253485827861328962_n.jpg'/>" + "<A HREF='https://descubribrown.ar/parapentes-aires-del-sur/'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Robinson = L.marker([-34.839381,-58.319434], {icon: azul},13).bindPopup("<strong>Las Vueltas de Robinson<strong>" + "<br/>" + "Av. Juan B. Justo 3699-3773,Ministro Rivadavia" + "<br/>" + "Contacto: 011 2492-3030" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/10/Copia-de-Vueltas-de-Robinson-5.jpg'/>" + "<A HREF='https://descubribrown.ar/las-vueltas-de-robinson/'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Mont = L.marker([-34.847995,-58.337644], {icon: azul},13).bindPopup("<strong>Mont Plaisir<strong>" + "<br/>" + "Juan B Justo 2000,Ministro Rivadavia" + "<br/>" + "Contacto: 1556968533" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/10/Copia-de-Copia-de-Mon-Plaisir-2.jpg'/>" + "<A HREF='https://descubribrown.ar/monplaisir/'> Mas info... </A> " ).on('click', xxy).addTo(map);
var Facundo = L.marker([-34.846589,-58.336754], {icon: azul},13).bindPopup("<strong>Don Facundo<strong>" + "<br/>" + "Juan B Justo 2100,Ministro Rivadavia" + "<br/>" + "Contacto: 1155166387" + " Email: facundoapple1701@gmail.com" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/09/Copia-de-Copia-de-Don-Facundo-14-1-scaled.jpg'/>" + "<A HREF='https://descubribrown.ar/granja-don-facundo/'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var mitai = L.marker([-34.8803615,-58.3329871], {icon: azul},13).bindPopup("<strong>Centro Comunitario Mitaí<strong>" + "<br/>" + "Constituyente 1199, Ministro Rivadavia" + "<br/>" + "Contacto: 1132659300" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/09/3-Centro-Comunitario-Mitai.pdf'/>" + "<A HREF='https://descubribrown.ar/centro-comunitario-mitai-2/'> Mas info... </A> " ).on('click', xxy).addTo(map);
var panificadora = L.marker([-34.854219,-58.350772], {icon: azul},13).bindPopup("<strong>Centro de Formación para el Trabajo en Panificados y Gastronomía<strong>" + "<br/>" + "Av Juan B Justo 900,Ministro Rivadavia" + "<br/>" + "Contacto: empleo@gmail.gob.ar" + "<br/>" + "<img src= 'imagenes/IMG1.jpg'/>" + "<A HREF='https://www.almirantebrown.gov.ar/'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var Sasaki = L.marker([-34.884281,-58.334975], {icon: azul},13).bindPopup("<strong>Sasaki<strong>" + "<br/>" + "Coronel Quesada 4441 Ministro Rivadavia" + "<br/>" + "Contacto: 1155958955	1155958955" + "<br/>" + "<img src= 'http://descubribrown.ar/wp-content/uploads/2023/08/Copia-de-Sasaki-2-scaled.jpg'/>" + "<A HREF='https://descubribrown.ar/granja-sasaki/'> Mas info... </A> " ).on('click', xxy).addTo(map);
...
var overlays = [
							 {
								...
								layers    : { 
									...
									"Centro Comunitario Mitaí": mitai
